...
AddOption(tpcMaxAttachedClustersPerSectorRow, unsigned int, 20000, "maxAttachedCls", 0, "Maximum number of TPC attached clusters which can be decoded per SectorRow")
