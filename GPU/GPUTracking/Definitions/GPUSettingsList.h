...
AddOption(comparableDebutOutput, int, -1, "", 0, "Make CPU and GPU debug output comparable (sort / skip concurrent parts), -1 = automatic if debugLevel >= 6")
...
AddOption(tpcMaxAttachedClustersPerSectorRow, unsigned int, 59000, "", 0, "Maximum number of TPC attached clusters which can be decoded per SectorRow")
