...
template <int NLayers>
void sortClustersHandler(const Cluster* unsorted,
                         Cluster* sorted,
...
template <int NLayers>
void registerClusterOwnershipHandler(const CellSeed* cellsLayersDevice,
                                     const int nCells,
...
// MC-only member collection (feeds the host majority-vote vertex labels).
template <int NLayers>
